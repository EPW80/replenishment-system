...
| [0010](0010-at-least-once-notification-delivery.md) | Deliver notifications at-least-once, not exactly-once | Accepted |
| [0011](0011-coolify-scheduled-tasks-for-nightly-jobs.md) | Run the nightly jobs as a Coolify scheduled task | Accepted |
| [0012](0012-notification-dispatch-on-its-own-schedule.md) | Run notification dispatch on its own five-minute schedule | Accepted |
