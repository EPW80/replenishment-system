...
.PHONY: help deps lint fmt test build run security migrate materialize notify db-up db-down clean
...
notify: ## Send lifecycle email for schedule created/paused/resumed/canceled
	go run ./cmd/notify
